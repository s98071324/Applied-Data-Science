...
```{r}
Prob.Ar <- (choose(4,2))*(5/8)*(5/8)*(3/8)*(3/8)
...
```{r}
library(readxl)
award_list <- read_excel("C:/Users/s9807/Downloads/1091-SHU-R-FinalExam/1091-SHU-R-FinalExam/award-list.xlsx")
View(award_list)
...
```{r}
A<-substr(award_list[,1] , 2:6 , "*")
B<-substr(award_list[,2],2:6,"*")
A
B
```
